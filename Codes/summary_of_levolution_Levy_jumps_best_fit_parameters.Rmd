...
main_dir <- "../"
data_dir <- paste0(main_dir, "Input_data/levolution_files_inference_actual_data/")
...
write.table(x = format(x = levolution_best_fit_parameters, digits=4), file = paste0(data_dir, "levolution_best_fit_parameters_summary.txt"), quote = F, row.names = T, col.names = T)
```